...
<?php $menuchecker = menuChecker('statistics_age'); ?> 
...
<?php startblock('content') ?>
  ...
  <?php include('views/reports/age.php'); ?>
<?php endblock() ?>
...
<script type="text/javascript">
  ...
  var table = $("#tb-suspects").DataTable({
    ...
    "columns": [
      ...
      { "data": "bracket1", "width": "15%", "className": 'text-center' },
      { "data": "bracket2", "width": "15%", "className": 'text-center' },
      { "data": "bracket3", "width": "15%", "className": 'text-center' },
      { "data": "bracket4", "width": "15%", "className": 'text-center' },
      { "data": "bracket5", "width": "15%", "className": 'text-center' },
      { "data": "bracket6", "width": "15%", "className": 'text-center' },
      { "data": "bracket7", "width": "15%", "className": 'text-center' },
    ],
    "order": [[0, 'asc']],
  ...
  function generateTableData($data) {
      ...
      $.each($data, function(key, item){
        ...
        tr += '<td style="vertical-align: middle;">'+item.bracket1+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.bracket2+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.bracket3+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.bracket4+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.bracket5+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.bracket6+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.bracket7+'</td>';
        tr += '</tr>';
      });
  ...
  $(document).on('click', '.btn-filter', function(){
    ...
    let lgu = $('#lgu').val();
    let path = "route/reports/filter_statistics_age.php?region="+region+"&province="+province+"&lgu="+lgu;
  ...
  $(document).on('click', '.btn-generate', function(){
    ...
    let province = $('#province').val();
    let lgu = $('#lgu').val();
    let path = "route/reports/generate_statistics_age.php?region="+region+"&province="+province+"&lgu="+lgu;
