			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="btn-group">
							<a href="statistics_population.php" class="btn btn-sm btn-secondary btn-block"><i class="fa fa-refresh" aria-hidden="true"></i> Clear</a>
						</div>
			...
			<div class="card-body">
				<table id="tb-suspects" class="table table-bordered table-striped">
					...
					<tbody id="tbody-suspects">
						<?php foreach ($population as $key => $dd): ?>
							<tr>
								<td><?= $dd['id']; ?></td>
								<td><?= $dd['region']; ?></td>
								<td><?= $dd['province']; ?></td>
