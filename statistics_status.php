...
<?php $menuchecker = menuChecker('statistics_status'); ?> 
...
<?php startblock('content') ?>
  ...
  <?php include('views/reports/status.php'); ?>
<?php endblock() ?>
...
<script type="text/javascript">
  ...
  function generateTableData($data) {
      ...
      $.each($data, function(key, item){
        ...
        tr += '<td style="vertical-align: middle;">'+item.current_status+'</td>';
        tr += '<td style="vertical-align: middle;">'+item.head_count+'</td>';
        tr += '</tr>';
      });
  ...
  $(document).on('click', '.btn-filter', function(){
    ...
    let lgu = $('#lgu').val();
    let path = "route/reports/filter_statistics_status.php?region="+region+"&province="+province+"&lgu="+lgu;
  ...
  $(document).on('click', '.btn-generate', function(){
    ...
    let province = $('#province').val();
    let lgu = $('#lgu').val();
    let path = "route/reports/generate_statistics_status.php?region="+region+"&province="+province+"&lgu="+lgu;
